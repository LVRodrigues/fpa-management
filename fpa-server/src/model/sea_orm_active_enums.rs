...
#[derive(Debug, Clone, PartialEq, Eq, EnumIter, DeriveActiveEnum, ToSchema, Serialize)]
#[sea_orm(rs_type = "String", db_type = "Enum", enum_name = "empirical")]
pub enum Empirical {
    #[sea_orm(string_value = "COODINATION")]
    Coodination,
...
#[derive(Debug, Clone, PartialEq, Eq, EnumIter, DeriveActiveEnum, ToSchema, Serialize)]
#[sea_orm(rs_type = "String", db_type = "Enum", enum_name = "factor")]
pub enum Factor {
...
#[derive(Debug, Clone, PartialEq, Eq, EnumIter, DeriveActiveEnum, ToSchema, Serialize)]
#[sea_orm(rs_type = "String", db_type = "Enum", enum_name = "influence")]
pub enum Influence {
